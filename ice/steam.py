...
import steam_paths
import winutils
from steam_model import LocalUserContext, Steam
...
def get_steam():
  ...
  if plat == 'Darwin':
    return helper(steam_paths.default_osx_userdata_path())
  if plat == 'Linux':
    return helper(steam_paths.default_linux_userdata_path())
